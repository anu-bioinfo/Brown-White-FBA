...
write.csv(ba_output, file=paste0(od, "/model_seahorse_nova_brown_predictions_v6.csv"))
save(ba_output, file=paste0(od, "/model_seahorse_nova_brown_predictions.RData"))
