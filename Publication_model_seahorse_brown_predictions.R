...
write.csv(ba_output, file=paste0(od, "/model_seahorse_brown_predictions_v6.csv"))
...
write.csv(ba_output2, file=paste0(od, "/model_seahorse_brown_predictions_v6pmt.csv"))
